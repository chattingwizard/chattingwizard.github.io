...
t.add_row("R-1", "Ice-break", "nice to meet you man 😏 so be honest,\nwhat caught your eye", "Add nombre antes de 'man'")
...
t.add_column("Message", style="white", width=65)
t.add_column("Technique", style="italic bright_magenta", width=20)
t.add_row("1", "I already sent you free shit man 😏 this one is on a whole different level... trust me", "Reminder")
...
t.add_row("3", "I get it, there's a lot of fake shit on here. but you felt that right?\n💪 let's not overthink this", "Grounding")
console.print(t)
console.print()
