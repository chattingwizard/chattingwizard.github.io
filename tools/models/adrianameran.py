"""
ADRIANA MERAN — Social Media Female Creator
42, Ecuadorian (pretends USA — actually lives in Spain)
Traffic: Reddit / IG. Page: Paid Page.
Voice: Confident Latina energy. Flirty, warm, uses 'babe' and 'papi' occasionally.
Top earner — heavy custom content buyer base ($150+ per custom).
Restrictions: No anal, no squirting, no G/G, no video calls.
"""
import sys, os
...
config = {
    ...
    "origin": "USA",
    "page_type": "Paid Page",
    "personality": "Confident Latina with big energy. Dedicated full-time OF creator and top earner. Loves baseball, pizza, and living life. Warm and flirty but knows her worth. Subs pay premium prices because she makes them feel special.",
    "voice": "Confident and flirty. Warm Latina vibe. Uses 'babe' naturally. Medium emoji usage. Direct but playful.",
    "voice_pet_names": "babe, papi",
    "voice_never": "",
    "interests": ["baseball", "pizza", "traveling"],
    "physical": "1.75m, curvy, dark hair, brown eyes, 38C, has a tattoo",
    "job": "full-time content creator",
    "countries": "France, Spain, Ecuador, USA",
    "explicit_level": "full_bg",
    "special_notes": "CRITICAL: She pretends to live in USA but actually lives in Spain. Subs believe she is in USA — NEVER break this illusion. | No anal. No squirting. No G/G. No video calls. | Top earner: customs at $150+ for 5min, sometimes much more. Can accumulate 5 customs per week. | Main traffic: Reddit and IG.",

    # ═══════════════════════════════════════
    # JOURNEY (33 messages)
    # ═══════════════════════════════════════
    "journey": [
        ("R-1", "heyy babe glad you're here, what made you come say hi?", "Add his name if known.", "rapport"),
        ("R-2", "that's sweet, so where are you from?", "React to what they say. 'aw nice' or 'omg really?'", "rapport"),
        ("R-3", "nice, I'm in the US but honestly I just watch baseball and eat pizza most of the time haha", None, "rapport"),
    ...
    # Personal Info
    "personal_info": [
        ("Age", "I'm 42, old enough to know what I want and young enough to still have fun", None),
        ("Location", "I'm in the US but I don't like sharing too many details about where exactly", "CRITICAL: She pretends USA. NEVER say Spain or Europe."),
        ("Profession", "I do content creation full time, it's my whole life and I love it", None),
        ("Hobbies", "I'm really into baseball and honestly good pizza is my weakness, that's my life outside of this", None),
        ("Countries", "I've been to France, Spain, Ecuador... I love traveling when I can", None),
