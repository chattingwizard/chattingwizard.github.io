...
config = {
    ...
    "journey": [
        ...
        ("S1-7", "fuck... talking to you does something to me I can't explain", "React to what he said. HE caused this.", "sext"),
    ...
    "nr_waves": [
        ...
        ("NR-W2", "you really need to see what I just did... trust me", "Send 3-5 min later. Curiosity.", "sext"),
