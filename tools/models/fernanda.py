...
config = {
    ...
    "journey": [
        ...
        ("S1-2", "mm I knew you'd like that", "React to what he says", "sext"),
        ("S1-3", "you want to see what happens when you get me in this kind of mood?", None, "sext"),
        ("S1-4", "give me a moment amor", "WAIT 2-3 MIN", "wait"),
        ("S1-5", "I don't show this to just anyone", "SEND PPV 1 — $12. Bought → continue. Silent 3 min → NR Waves.", "ppv"),

        # ── Sexting Phase 2 → PPV 2 ($25) ──
        ("S1-6", "did you see it?", "Wait for reply. Brief cooldown.", "sext"),
        ("S1-7", "fuck... you're making me feel things I haven't felt in so long", "React to what he said. HE caused this.", "sext"),
        ("S1-8", "I'm dripping right now and it's completely your fault", None, "sext"),
        ...
        ("S1-11", "look what you did", "SEND PPV 2 — $25. Bought → continue. Silent 3 min → NR Waves.", "ppv"),
